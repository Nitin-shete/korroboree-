                     ...
                     <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                           ...
                           <li class="sidebar-list">
                              <a class="sidebar-link sidebar-title link-nav" href="<?php echo base_url();?>admin/v5/dashboard">
                           ...
                           <li class="sidebar-list">
                              <a class="sidebar-link sidebar-title link-nav" href="<?php echo base_url();?>admin/v5/video_journal">
                                 <i data-feather="layout"></i>
