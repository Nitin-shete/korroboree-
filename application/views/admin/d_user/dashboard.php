                        ...
                        <div class="col-6">
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item">
                                 <a href="<?php echo base_url();?>admin/v5/dashboard">
                           ...
                           <div class="card-body">
                              <div class="greeting-user text-center">
                                 <div class="profile-vector">
                                    <img class="img-fluid" src="<?php echo base_url(); ?>assets/admin/d_user/assets/images/dashboard/welcome.png" alt="">
                                 </div>
                                 <h4 class="f-w-600">
                        ...
                        <div class="card o-hidden profile-greeting">
                           <div class="card-body">
                              <div class="greeting-user text-center">
                                 ...
                                 <div class="whatsnew-btn">
                                    <a class="btn btn-primary" href="<?php echo base_url();?>admin/v5/video_journal">Let's Go!</a>
                                 </div>
                              </div>
                           </div>
                        </div>
