<main class="cd-main-content">
         ...
         <section class="section white-section section-padding-top-bottom">
            ...
            <div class="container" style="text-align: justify;">
               <h2 style="text-align: center;padding: 30px">Korroboree Terms of Service</h2>
               <br>

               <div class="ar columns" style="width: 70rem; margin-left: 45px;">
                  <div class="accordion smk_accordion acc_with_icon">
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 0.3s"
                        data-scroll-reveal-id="8" data-scroll-reveal-initialized="true"
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>OVERVIEW
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           <p>This website is operated by Korroboree. Throughout the site, the terms “we”, “us” and
                              “our” refer to Korroboree. Korroboree offers this website, including all information,
                           ...
                           <br>
                           <p>
                              Our store is hosted on Hostinger.They provide us with the online e-commerce platform that
                              allows us to sell our products and services to you.
                           </p>
                        </div>
                     </div>

                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 0.6s"
                        data-scroll-reveal-id="9" data-scroll-reveal-initialized="true"
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 1 - ONLINE STORE TERMS
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        data-scroll-reveal-id="11" data-scroll-reveal-initialized="true"
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 2 - GENERAL CONDITIONS
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <p>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF
                           INFORMATION
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           <p>
                              ...
                              consulting primary, more accurate, more complete or timelier sources of information. Any
                          ...
                          <br>
                           <p>
                              ...
                              <br>FACEBOOK - <a href="https://www.facebook.com/settings/?tab=ads "
                                 target="_balnk">https://www.facebook.com/settings/?tab=ads </a>
                              <br>GOOGLE - <a href="https://www.google.com/settings/ads/anonymous "
                                 target="_balnk">https://www.google.com/settings/ads/anonymous </a>
                              <br> BING - <a
                           ...
                           <p class="bold_txt">DO NOT TRACK</p>
                           ...
                           <p class="bold_txt">YOUR RIGHTS</p>
                           <br>
                           ...
                           <br>
                           <p class="bold_txt">DATA RETENTION</p>
                           <br>
                           <p>When you place an order through the Site, we will maintain your Order Information for
                              our records unless and until you ask us to delete this information.</p>
                           <br>
                           <p class="bold_txt"> MINORS</p>
                           <br>
                           <p>The Site is not intended for individuals under the age of 18.</p>
                           <br>
                           <p class="bold_txt">CHANGES</p>
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <p>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 5 - PRODUCTS OR SERVICES (if applicable)
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div> SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           <p>
                           ...
                           <p>You agree to provide current, complete and accurate purchase and account information for
                              ...
                              that we can complete your transactions and contact you as needed. </p>
                           <br>
                           <p>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 7 - OPTIONAL TOOLS
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 10 - PERSONAL INFORMATION
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 12 - PROHIBITED USES
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF
                           LIABILITY
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           ...
                           <br>
                           <p>We do not warrant that the results that may be obtained from the use of the service will
                           ...
                           <p>You expressly agree that your use of, or inability to use, the service is at your sole
                              ...
                              quality, fitness for a particular purpose, durability, title, and non-infringement. </p>
                           <br>
                           <p>In no case shall Korroboree, our directors, officers, employees, affiliates, agents,
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 14 - INDEMNIFICATION
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           <p>
                              You agree to indemnify, defend and hold harmless Korroboree and our parent, subsidiaries,
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 15 - SEVERABILITY
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 16 - TERMINATION
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           ...
                           <p>These Terms of Service are effective unless and until terminated by either you or us. You
                              ...
                              to use our Services, or when you cease using our site.</p>
                           <br>
                           <p>If in our sole judgment you fail, or we suspect that you have failed, to comply with any
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 17 - ENTIRE AGREEMENT
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 18 - GOVERNING LAW
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           <p>These Terms of Service and any separate agreements whereby we provide you Services shall
                              be governed by and construed in accordance with the laws of India.</p>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 19 - CHANGES TO TERMS OF SERVICE
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                     ...
                     <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                        ...
                        data-scroll-reveal-complete="true">
                        <div class="acc_head white-section">
                           <div class="acc_icon_expand"></div>SECTION 20 - CONTACT INFORMATION
                        </div>
                        <div class="acc_content white-section" style="display: none;">
                           <br>
                           <p>Questions about the Terms of Service should be sent to us at kunal@whitecollarlegal.in.
                           </p>
                        </div>
                     </div>
...
<section class="section footer-1 section-padding-top-bottom">
   ...
   <!-- JAVASCRIPT
         ...
         <script src="<?php echo base_url(); ?>assets/web/assets/js/visible.min.js"></script>
         <script src="<?php echo base_url(); ?>assets/web/assets/js/pro-bars.js"></script>
         <script src="<?php echo base_url(); ?>assets/web/assets/js/jquery.counterup.min.js"></script>
         <script src="<?php echo base_url(); ?>assets/web/assets/js/waypoints.min.js"></script>
         <script src="<?php echo base_url(); ?>assets/web/assets/js/smk-accordion.js"></script>
         <script src="<?php echo base_url(); ?>assets/web/assets/js/jquery.fitvids.js"></script>
         <script src="<?php echo base_url(); ?>assets/web/assets/js/custom-about-2.js"></script>
