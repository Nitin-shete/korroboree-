 <main class="cd-main-content">
         ...
         <section class="section white-section section-padding-top-bottom">
            ...
            <div class="container" style="text-align: justify;">
               <h2 style="text-align: center;padding: 30px">Korroboree Privacy Policy</h2>
               <br>
               <div style="color: black !important; text-align: center;">
                  <p>This Privacy Policy describes how your personal information is collected, used, and shared when you
                     visit or make a purchase from www.korroboree.com (the “Site”).</p>
               </div>
               <br>
                     ...
                     <div class="accordion smk_accordion acc_with_icon">
                        ...
                        <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 0.3s"
                           ...
                           <div class="acc_head white-section">
                              <div class="acc_icon_expand"></div>PERSONAL INFORMATION WE COLLECT
                           </div>
                           <div class="acc_content white-section" style="display: none;">
                              <p>When you visit the Site, we automatically collect certain information about your
                                 ...
                                 of the cookies that are installed on your device. Additionally, as you browse the Site,
                                 ...
                                 Information.”</p>
                              <br>
                              <p class="bold_txt">We collect Device Information using the following technologies:</p>
                              <br>
                              <p> - “Cookies” are data files that are placed on your device or computer and often
                                 ...
                                 disable cookies, visit http://www.allaboutcookies.org.</p>
                              <br>
                              ...
                              <p> Additionally when you make a purchase or attempt to make a purchase through the Site,
                                 ...
                                 address, payment information (including credit card numbers ,upi id, email address, and
                                 phone number), email address, and phone number. We refer to this information as “Order
                                 Information.”</p>
                              <br>
                        ...
                        <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 0.6s"
                           ...
                           data-scroll-reveal-complete="true">
                           <div class="acc_head white-section">
                              <div class="acc_icon_expand"></div>HOW DO WE USE YOUR PERSONAL INFORMATION?
                           </div>
                           <div class="acc_content white-section" style="display: none;">
                              <p>We use the Order Information that we collect generally to fulfill any orders placed
                                 ...
                                 shipping, and providing you with invoices and/or order confirmations). Additionally, we
                                 use this Order Information to:</p>
                              <br>
                              <p class="bold_txt">Communicate with you;</p>
                              <p>Screen our orders for potential risk or fraud; and</p>
                              <p>When in line with the preferences you have shared with us, provide you with information
                                 or advertising relating to our products or services.</p>
                              <br>
                        ...
                        <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                           ...
                           data-scroll-reveal-complete="true">
                           <div class="acc_head white-section">
                              <div class="acc_icon_expand"></div>SHARING YOUR PERSONAL INFORMATION
                           </div>
                           <div class="acc_content white-section" style="display: none;">
                              <p>We share your Personal Information with third parties to help us use your Personal
                                 ...
                                 store--you can read more about how Shopify uses your Personal Information here:
                                 ...
                                 also opt-out of Google Analytics here: https://tools.google.com/dlpage/gaoptout</p>
                        ...
                        <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                           ...
                           data-scroll-reveal-complete="true">
                           <div class="acc_head white-section">
                              <div class="acc_icon_expand"></div>BEHAVIOURAL ADVERTISING
                           </div>
                           <div class="acc_content white-section" style="display: none;">
                              ...
                              <br>
                              <p class="bold_txt">You can opt out of targeted advertising by:</p>
                              <br>
                              <p>
                        ...
                        <div class="accordion_in" data-scroll-reveal="enter left move 200px over 1s after 1.2s"
                           ...
                           data-scroll-reveal-complete="true">
                           <div class="acc_head white-section">
                              <div class="acc_icon_expand"></div>CONTACT US
                           </div>
                           <div class="acc_content white-section" style="display: none;">
                              <br>
                              <p>For more information about our privacy practices, if you have questions, or if you
                                 ...
                                 kunal@whitecollarlegal.in or by mail using the details provided below:</p>
                              <br>
                              <p>Office Number 5 and 6, 2nd Floor, Devika Heights, Above NITS Global, next to Bhawkar
                                 Garage, Shivajinagar, Pune, Maharashtra 411005, Pune, MH, 411005, India</p>
                           </div>
                        </div>
