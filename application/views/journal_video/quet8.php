            ...
            <div class="row justify-content-center  midrow">
                ...
                <div class="col-lg-7 col-md-7">
                    ...
                    <div class="que_bg bg-yellow" id="mcq1">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                According to Rick, what is the leading cause of depression?
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row  option1 opt_que " id="opt1" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Loneliness</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option3 opt_que " id="opt3" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Shredded connections</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option3 opt_que " id="opt4" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Expectations to multitask</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option2 opt_que" id="opt2" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">All of the above</div>
                                    <div class="col-lg-1 col-md-1">
                    ...
                    <div id="mcq2" class="que_bg bg-yellow" style="display: none;">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                What are three things/activities that you can try as a family to keep depression at bay?
                    ...
                    <button type="button" class="next bg-grey-dark txt_wht tools" id="qe22" style="display: none; cursor:not-allowed;">
                        ...
                        <div class="cd-popup" role="alert">
                            <div class="cd-popup-container">
                                <p>Every segment you complete changes your brain. You will not be the same. You will be better.</p>
                                <ul class="cd-buttons">
                                    <li><a href="<?php echo base_url(); ?>video_journal/seg9">Yes</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-7 mt-10">
                    <div class="seg_back bg-grey-dark font_tahoma ">
                        <center class="seg_clr txt_seg">Segment 8</center>
                        <center class="txt-yellow txt2_seg">Thoughts on Depression (the dreaded D-word)</center>
                    </div>
                </div>
            </div>
            <footer>
                <button type="button" onclick='window.location.href="<?php echo base_url(); ?>video_journal/seg9"' class=" crcl card-yellow tools" id="btn" style="float:right;  margin-right: 34px;"  disabled>
                ...
                <button  type="button" class="crcl card-yellow" style="float: right; margin-right: 20px; ">
                    <a href="<?php echo base_url(); ?>video_journal/seg8">
                ...
                <center>
                    <div class="modal-content modal_body">
                        ...
                        <div class="modal-body">
                            ...
                            <textarea name="" id="t1" maxlength="250" rows="6" cols="70"  class="opt_que snqe"></textarea>
                            <div class="input_size">input 2</div>
                            <textarea name="" id="t2" maxlength="250" rows="6" cols="70" class="opt_que snqe"></textarea>
                            <div class="input_size">input 3</div>
                            <textarea name="" id="t3" maxlength="250" rows="6" cols="70" class="opt_que snqe"></textarea>
                        </div>
