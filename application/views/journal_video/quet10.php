            ...
            <div class="row justify-content-center  midrow">
                ...
                <div class="col-lg-7 col-md-7">
                    ...
                    <div class="que_bg bg-yellow" id="mcq1">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                How can I ensure that my child is more attentive ?
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                ...
                                <div class="row option2 opt_que" id="opt2" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Make them a part of mindfulness training</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class=" row option1 opt_que" id="opt1" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Make sure they sit in one place till the activity has been
                                        completed</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class=" row option1 opt_que" id="opt3" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Make peace with the fact that they are not naturally
                                        attentive, and they will never be</div>
                                    <div class="col-lg-1 col-md-1">
                    ...
                    <div id="mcq2" class="que_bg bg-yellow" style="display: none;">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                Your child has been constantly playing games on your phone. He/she doesn’t listen when you tell them
                                to stop. What is the best way to tackle this?
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row option1 opt_que snqe" id="q2opt1">
                                    <div class="col-lg-11 col-md-11">I give up. There is no way out!</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option2 opt_que  snqe" id="q2opt2">
                                    <div class="col-lg-11 col-md-11">I take charge. I take away all the devices!</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class=" row option3 opt_que snqe" id="q2opt3">
                                    <div class="col-lg-11 col-md-11">  I change. I make my child shift his/her preference for
                                        video games to reading or painting or another activity that interests them.</div>
                                    <div class="col-lg-1 col-md-1">
                    ...
                    <button type="button" class="next bg-grey-dark txt_wht tools" id="qe22" style="display: none; cursor:not-allowed;">
                        ...
                        <div class="cd-popup" role="alert">
                            <div class="cd-popup-container">
                                <p>‘Those who keep learning, will keep rising in life’. Let’s keep learning and rising.</p>
                                <ul class="cd-buttons">
                                    <li><a href="<?php echo base_url(); ?>video_journal/seg11">Yes</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-7 mt-10">
                    <div class="seg_back bg-grey-dark font_tahoma ">
                        <center class="seg_clr txt_seg">Segment 10</center>
                        <center class="txt-yellow txt2_seg">Attention span</center>
                    </div>
                </div>
            </div>
            <footer>
                <button type="button" onclick='window.location.href="<?php echo base_url(); ?>video_journal/seg11"' class=" crcl card-yellow tools" id="btn" style="float:right;  margin-right: 34px;"  disabled>
                ...
                <button  type="button" class="crcl card-yellow" style="float: right; margin-right: 20px; ">
                    <a href="<?php echo base_url(); ?>video_journal/seg10">
