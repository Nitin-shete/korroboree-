            ...
            <div class="row justify-content-center  midrow">
                ...
                <div class="col-lg-7 col-md-7">
                    ...
                    <div class="que_bg bg-yellow" id="mcq1">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                Positive neuroplasticity is when our neurons fire and wire together to make us a better
                                person.
                            </div>
                        </div>
                        <div class="row justify-content-center">
                    ...
                    <div id="mcq2" class="que_bg bg-yellow" style="display: none;">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                List three ways to make your life experiences / situations more positive.
                                (Clue: Listening to cheerful music or watching a movie that inspires you)
                    ...
                    <button type="button" class="next bg-grey-dark txt_wht tools" id="qe22"
                        ...
                        <div class="cd-popup" role="alert">
                            <div class="cd-popup-container">
                                <p>What you learn you will teach your children. What you teach your children they will teach their children. You will leave a legacy for generations to come.</p>
                                <ul class="cd-buttons">
                                    <li><a href="<?php echo base_url(); ?>video_journal/seg10">Yes</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-7 mt-10">
                    <div class="seg_back bg-grey-dark font_tahoma ">
                        <center class="seg_clr txt_seg">Segment 9</center>
                        <center class="txt-yellow txt2_seg">Positive neuroplasticity</center>
                    </div>
                </div>
            </div>
            <footer>
                <button type="button" onclick='window.location.href="seg10.html"' class=" crcl card-yellow tools"
