                        ...
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row  option1 opt_que " id="opt1" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Travelling to a zoo with your child</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option3 opt_que " id="opt3" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Swimming with your child</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option2 opt_que" id="opt4" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Having a pizza with your child</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option4 opt_que " id="opt2" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Sharing your life-changing experiences with your
                                        child</div>
                                    <div class="col-lg-1 col-md-1">
                        ...
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row option1 opt_que snqe" id="q2opt1">
                                    <div class="col-lg-11 col-md-11">Hedonic</div>
                                    <div class="col-lg-1 col-md-1">
                                        <span class="ex que2_op1_w1" style="display: none;">&#215;</span>
                                    </div>

                                </div>
                                <div class="row option2 opt_que  snqe" id="q2opt3">
                                    <div class="col-lg-11 col-md-11">Eudemonic</div>
                                    <div class="col-lg-1 col-md-1">
                    ...
                    <button type="button" class="next bg-grey-dark txt_wht tools" id="qe22" style="display: none; cursor:not-allowed;" >
                        ...
                        <div class="cd-popup" role="alert">
                            <div class="cd-popup-container">
                                <p>‘Never stop learning because life never stops teaching’ Ready?</p>
                                <ul class="cd-buttons">
                                    <li><a href="<?php echo base_url(); ?>video_journal/seg8">Yes</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-7 mt-10">
                    <div class="seg_back bg-grey-dark font_tahoma ">
                        <center class="seg_clr txt_seg">Segment 7</center>
                        <center class="txt-yellow txt2_seg">‘Hedonic’ and ‘Eudemonic’ feelings</center>
                    </div>
                </div>
            </div>
            <footer>
                <button type="button" onclick='window.location.href="<?php echo base_url(); ?>video_journal/seg8"' class=" crcl card-yellow tools" id="btn" style="float:right;  margin-right: 34px;"  disabled>
                ...
                <button  type="button" class="crcl card-yellow" style="float: right; margin-right: 20px; ">
                    <a href="<?php echo base_url(); ?>video_journal/seg7">
