            ...
            <div class="row justify-content-center  midrow">
                ...
                <div class="col-lg-7 col-md-7">
                    ...
                    <div class="que_bg bg-yellow" id="mcq1">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                Why do you think Rick tells us not to speak or act out of anger?
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row  option1 opt_que " id="opt1" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Being angry is not good for your relationships</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option3 opt_que " id="opt3" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Others will judge you for being angry</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option2 opt_que" id="opt2" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Anger has a deep impact, and anything said or done out
                                        of anger <br> can have long-lasting effects on young minds.</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option3 opt_que " id="opt4" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">Anger will not help in resolving all problems</div>
                                    <div class="col-lg-1 col-md-1">
                    ...
                    <div id="mcq2" class="que_bg bg-yellow" style="display: none;">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                Your child wants to join a music class, but you are not inclined towards the same. What would you
                                do?
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row option1 opt_que snqe" id="q2opt1">
                                    <div class="col-lg-11 col-md-11">Let your child join a class that he / she may enjoy</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option2 opt_que snqe " id="q2opt2">
                                    <div class="col-lg-11 col-md-11">Be blunt and refuse your child’s request </div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class=" row option4 opt_que snqe" id="q2opt4">
                                    <div class="col-lg-11 col-md-11"> Make excuses and then tell them not to join</div>
                                    <div class="col-lg-1 col-md-1">
                                        <p class="ex que2_op1_w3" style="display: none;">&#215;</p>
                                    </div>
                                </div>
                                <div class=" row option3 opt_que snqe" id="q2opt3">
                                    <div class="col-lg-11 col-md-11"> Tell your child to research about the nature of the
                                        music class and then <br> let them decide</div>
                                    <div class="col-lg-1 col-md-1">
                    ...
                    <button type="button" class="next bg-grey-dark txt_wht tools" id="qe22" style="display: none; cursor:not-allowed;">
                        ...
                        <div class="cd-popup" role="alert">
                            <div class="cd-popup-container">
                                <p>Learn. Believe. Change. Grow. Become.</p>
                                <ul class="cd-buttons">
                                    <li><a href="<?php echo base_url(); ?>video_journal/seg7">Yes</a></li>
            ...
            <footer>
                <button type="button" onclick='window.location.href="<?php echo base_url(); ?>video_journal/seg7"' class=" crcl card-yellow tools" id="btn" style="float:right;  margin-right: 34px;"  disabled>
                ...
                <button  type="button" class="crcl card-yellow" style="float: right; margin-right: 20px; ">
                    <a href="<?php echo base_url(); ?>video_journal/seg6">
