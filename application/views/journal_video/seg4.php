            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-7">
                    <div class="seg_back bg-grey-dark font_tahoma ">
                        <center class="seg_clr txt_seg">Segment 4</center>
                        <center class="txt-yellow txt2_seg">How can we deal with suffering and usher in happiness amidst
                            adversities</center>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function ends() {
            window.location.href = "<?php echo base_url(); ?>video_journal/quet4"
