            ...
            <div class="row justify-content-center  midrow">
                ...
                <div class="col-lg-7 col-md-7">
                    ...
                    <div class="que_bg bg-yellow" id="mcq1">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                According to Rick, how can teachers focus on social emotional development in children?
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row  option1 opt_que " id="opt1" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">By making children memorise lessons.</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option2 opt_que" id="opt2" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">By inculcating essential habits, values and sharing
                                        real-life experiences.</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option3 opt_que " id="opt3" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">By taking more standardized tests.</div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option3 opt_que " id="opt4" onclick="select1(this)">
                                    <div class="col-lg-11 col-md-11">By making them read more books.</div>
                                    <div class="col-lg-1 col-md-1">
                                        <p class="ex wrg3" style="display: none;">
                                            &#215;
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div id="mcq2" class="que_bg bg-yellow" style="display: none;">
                        <div class="row">
                            <div class="que txt-grey-dark">
                                As a parent, what would be an ideal school for your child?
                        ...
                        <div class="row justify-content-center">
                            <div class="opts" id="back">
                                <div class="row option1 opt_que snqe " id="q2opt1">
                                    <div class="col-lg-11 col-md-11">A school where discipline is the law.
                                    </div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class="row option2 opt_que snqe  " id="q2opt2">
                                    <div class="col-lg-11 col-md-11">A school where tests are taken every week.
                                    </div>
                                    <div class="col-lg-1 col-md-1">
                                ...
                                <div class=" row option3 opt_que snqe " id="q2opt3">
                                    <div class="col-lg-11 col-md-11">A school where teachers are respected and are free to inculcate life-values in children.
                                ...
                                <div class=" row option4 opt_que snqe " id="q2opt4">
                                    <div class="col-lg-11 col-md-11"> A school where more importance is given to academics than sports, music or any other co-curricular activities.
                                    </div>
                                    <div class="col-lg-1 col-md-1">
                    ...
                    <button type="button" class="next bg-grey-dark txt_wht tools" id="qe22" style="display: none; cursor:not-allowed;">
                        ...
                        <div class="cd-popup" role="alert">
                            <div class="cd-popup-container">
                                <p>‘Life is not about who you once were. It’s about who you have the potential to be’.</p>
                                <ul class="cd-buttons">
                                    <li><a href="<?php echo base_url(); ?>video_journal/seg6">Yes</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-7 mt-10">
                    <div class="seg_back bg-grey-dark font_tahoma ">
                        <center class="seg_clr txt_seg">Segment 5</center>
                        <center class="txt-yellow txt2_seg">Changes in current education system</center>
                    </div>
                </div>
            </div>
            <footer>
                <button type="button" onclick='window.location.href="<?php echo base_url(); ?>video_jouseg6"' class=" crcl card-yellow tools" id="btn" style="float:right;  margin-right: 34px;"  disabled>
                ...
                <button  type="button" class="crcl card-yellow" style="float: right; margin-right: 20px; ">
                    <a href="<?php echo base_url(); ?>video_jouseg5">
